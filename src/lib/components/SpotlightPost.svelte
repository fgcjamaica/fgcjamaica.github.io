...
>
	...
	>
		<div class="flex flex-col mb-6">
			<!-- Date Published -->
			<h3 class="font-montserrat font-semibold text-rich-black">{metadata?.datePublished}</h3>
			<!-- Post Title -->
			<h3 class="font-bold text-5xl leading-[1.4] rounded-full">
				<span class="inline bg-white  highlight">{metadata?.title}</span>
			</h3>

			<!-- Read Time -->
			<h3 class="font-montserrat font-semibold text-rich-black">

...
const profilesWithoutImage = [
  {
    ...
    name: "Ajani Hickling",
    socials: [
      github("ajanihickling"), instagram("ajanihickling"),
    ]
  },
  {
    id: "ajani-hickling",
    name: "Chelsea Rerrie",
    socials: [
      github("chelse"), instagram("cherry.jpeg"),
    ]
  }
] as const;
...
export const profiles = await Promise.all(profilesWithoutImage.map(async profile => {
  return {
    ...profile,
